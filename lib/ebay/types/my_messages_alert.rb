...
module Ebay # :nodoc:
  module Types # :nodoc:
    ...
    #  date_time_node :receive_date, 'ReceiveDate', :optional => true
    #  date_time_node :expiration_date, 'ExpirationDate', :optional => true
    #  date_time_node :resolution_date, 'ResolutionDate', :optional => true
    #  date_time_node :last_read_date, 'LastReadDate', :optional => true
