...
module Ebay # :nodoc:
  module Types # :nodoc:
    ...
    #  date_time_node :bank_modify_date, 'BankModifyDate', :optional => true
    #  numeric_node :billing_cycle_date, 'BillingCycleDate', :optional => true
    #  date_time_node :credit_card_expiration, 'CreditCardExpiration', :optional => true
    #  text_node :credit_card_info, 'CreditCardInfo', :optional => true
    #  date_time_node :credit_card_modify_date, 'CreditCardModifyDate', :optional => true
