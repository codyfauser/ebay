...
module Ebay # :nodoc:
  module Types # :nodoc:
    ...
    #  date_time_node :promotional_sale_start_time, 'PromotionalSaleStartTime', :optional => true
    #  date_time_node :promotional_sale_end_time, 'PromotionalSaleEndTime', :optional => true
